...
import ICON_TYPE_EMAIL from '@/components/atoms/StyledTable/assets/icon-type-email.svg';
import ICON_TYPE_PHONE from '@/components/atoms/StyledTable/assets/icon-type-phone.svg';
import ICON_TYPE_CURRENCY from '@/components/atoms/StyledTable/assets/icon-type-currency.svg';
import ICON_TYPE_DATE from '@/components/atoms/StyledTable/assets/icon-type-date.svg';
import ICON_TYPE_URL from '@/components/atoms/StyledTable/assets/icon-type-url.svg';
