...
import ICON_SUCCESS from '@/components/molecules/EnrichmentDetail/assets/dialog/DialogActionsMenu/icon_success.svg';
import ICON_WARNING from '@/components/molecules/EnrichmentDetail/assets/dialog/DialogActionsMenu/icon_warning_triangle.svg';
