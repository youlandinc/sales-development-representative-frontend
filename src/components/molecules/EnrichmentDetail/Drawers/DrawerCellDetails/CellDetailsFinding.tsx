...
import { CellDetailsContainer } from './base';

import { UTypeOf } from '@/utils';

interface CellDetailsFindingProps {
...
export const CellDetailsFinding: FC<CellDetailsFindingProps> = ({
  cellDetails,
}) => {
  ...
  return (
    <CellDetailsContainer isEmpty={UTypeOf.isEmptyObject(metaData)}>
      <Stack
        sx={{
          flex: 1,
          gap: 3,
