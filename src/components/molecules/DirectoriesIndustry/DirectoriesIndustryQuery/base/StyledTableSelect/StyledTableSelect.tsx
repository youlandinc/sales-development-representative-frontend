...
import { StyledTableSelectInput } from './StyledTableSelectInput';
import { StyledTableSelectDialog } from './StyledTableSelectDialog';

import { FilterElementTypeEnum, ProspectTableEnum } from '@/types';
import { CONSTANTS } from './StyledTableSelect.styles';
...
export const StyledTableSelect: FC<FilterTableSelectProps> = ({
  type,
  selectedTableId,
  selectedTableName,
  selectedTableSource,
