...
export const CampaignsPending = () => {
  ...
  const baseInfo = {
    sentOn: '2024-12-20T00:40:36.192890Z',
    subject: 'ggggg',
    from: 'mace@youland.com',
  };
            ...
            timeline={[
              {
                ...
                sent: 9,
                unSent: 0,
                status: MarketingReportProcessStatusEnum.completed,
              ...
              },
              {
                ...
                sent: null,
                unSent: null,
                status: MarketingReportProcessStatusEnum.scheduled,
